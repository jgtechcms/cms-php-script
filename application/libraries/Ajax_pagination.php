...
class Ajax_pagination{
    ...
    var $next_link       = '<span class="icon icon-chevron_right"></span>';
    var $prev_link       = '<span class="icon icon-chevron_left"></span>';
    var $last_link       = 'Last';
    var $uri_segment     = 3;
    var $full_tag_open   = '<div class="filters-row__pagination"><ul class="pagination">';
	...
	var $showing_open	 = '<div class="filters-row__items hidden-sm hidden-xs">';
	var $showing_close	 = '</div>';
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            $info = $this->showing_open . 'Showing : ' . $this->total_rows . $this->showing_close;
            return $info;
        }
        ...
        if ($this->show_count){
            ...
            $info = $this->showing_open . 'Showing ' . ( $curr_offset + 1 ) . ' to ' ;
            ...
            $info .= ' of ' . $this->total_rows . $this->showing_close;
            //$output .= $info;
        }
    ...
    function getAJAXlink($count, $text) {
		...
		/*if($pageCount == 0) {
			...
			$pageCount = round($pageCount/$this->per_page)+1;
		}*/
