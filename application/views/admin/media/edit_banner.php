									  ...
									  <div class="starter-template">										
											...
											<form method="POST" role="form" id="frmAdd" enctype="multipart/form-data"> 
												...
												<div class="form-group required"> 
													...
													<select name="menu_id" class="select form-control">
														<?php foreach($menus as $menu):?>
															<option value="<?php echo $menu->id;?>"<?php if($menu->id == set_value('menu_id', $banner->menu_id)):?> selected<?php endif;?>><?php echo $menu->title;?></option>
														<?php endforeach;?>
													</select>
												</div> 
												...
												<div class="form-group required"> 
													...
													$file_thumb = $customer_banner_folder . $banner->banner_image;
												...
												<div class="form-group"> <label  class="">Description</label>
													<?php 
													$description = set_value('description', $banner->description);
													?>
