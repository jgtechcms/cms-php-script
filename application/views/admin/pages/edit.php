...
<script src="<?php echo site_url(ASSET)?>/admin/js/jquery-ui-autocomplete.js"></script>
<style>
										...
										<div class="form-group required"> <label  class="">Menu</label> </div> 
										   <div class="form-group">  
											   <select id="menu_add_page" name="menu" class="form-control select menu_add_page" >      
												...
												<?php if(count($sub_menu_edit)): foreach($sub_menu_edit as $menu): ?>	
													<option data-menu_name="<?php echo $menu->title;?>" data-is_product="<?php echo $menu->is_product;?>" value="<?php echo $menu->id;?>"<?php if(set_value('menu', $page_detail->menu_id) == $menu->id){ echo ' selected';}?>><?php echo $menu->title;?></option>
											...
											<input type="text" name="title"  class="form-control" value="<?php echo set_value('title', $page_detail->title)?>" placeholder="H1 Title">   </div>  
											<div class="form-group"> <label  class="">Meta Title <?php //echo get_tooltip('tooltip_pages_title'); ?></label>
											<input type="text" name="meta_title"  class="form-control" value="<?php echo set_value('meta_title', $page_detail->meta_title)?>" placeholder="<?php echo config_item('form_field_pages_title');?>">   </div> 
											<div class="form-group"> <label  class="">Meta Keywords</label>
											<input type="text" name="meta_tag"  class="form-control" value="<?php echo set_value('meta_tag', $page_detail->meta_keywords)?>" placeholder="<?php echo config_item('form_field_pages_meta_tag');?>">   </div> 

											<div class="form-group"> <label  class="">Meta Description</label></div> 
											<div class="form-group"> <textarea name="meta_desc" class="form-control" placeholder="<?php echo config_item('form_field_pages_meta_description');?>"><?php echo set_value('meta_desc', $page_detail->meta_description)?></textarea>  </div> 
                                        ...
                                        <div class="ui-widget" style="margin-top:2em; font-family:Arial">
                                          ...
                                          <ul id="product-related" style="height: 250px; width: 300px; overflow: auto;" class="sortable ui-widget-content">
                                            ...
                                            foreach($product_related as $related):?>
                                                <li class="ui-state-default" id="widget-<?php echo $related->id;?>"><i class="fa fa-minus-circle"></i> <?php echo $related->name;?><input type="hidden" name="product_related[]" value="<?php echo $related->id;?>" /></li>
                                            <?php 
                                            endforeach;?>
                                            <?php 
