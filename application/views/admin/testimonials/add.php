								...
								<div class="col-md-6">
									...
									<form method="POST" role="form" id="frmAdd" enctype="multipart/form-data"> 
										...
										<div class="form-group"> 
											...
											<input type="text" name="company_url" id="company_url" class="form-control" value="<?php echo set_value('company_url')?>">   
										</div>  
										<div class="form-group required"> 
											...
											if($this -> input -> post('id')) {
												...
												$file_thumb = $customer_testimonial_icon_folder . $this -> input -> post('old_file');
										...
										<div class="form-group">
										<textarea name="body_desc" id="body_desc" class="form-control" ><?php echo set_value('body_desc')?></textarea>
