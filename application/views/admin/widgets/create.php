									  ...
									  <div class="starter-template">										
											...
											<form method="POST" role="form" id="frmAdd" enctype="multipart/form-data"> 
												...
												<div class="form-group required"> 
													...
													<select name="widget_type_id" class="form-control select">
														...
														<?php foreach($widget_types as $widget_type):?>
															<option value="<?php echo $widget_type->id;?>"<?php if($widget_type->id == set_value('widget_type_id')):?> selected<?php endif;?>><?php echo $widget_type->name;?></option>
														<?php endforeach;?>
													</select>
												</div> 
                                                ...
                                                <div class="form-group dispay_limit_section"<?php echo $limit_display;?>> 
													...
													<input type="text" name="page_limit" class="form-control" value="<?php echo set_value('page_limit');?>">
                                                     
                                                </div>
                                                
                                                <div class="form-group"> 
                                                    <label  class="">Section title</label>
                                                    <input type="text" name="section_title" class="form-control" value="<?php echo set_value('section_title');?>">
                                                </div>
                                                
                                                <?php
												$content_layout = set_value('content_layout');
                                                ...
                                                <div class="custom_section"<?php echo $custom_display;?>>
                                                    ...
                                                    <div id="single_column_content_section">
                                                        ...
                                                        <div class="form-group">
                                                        <textarea name="single_column_content" class="tinymce"><?php echo set_value('singe_column_content');?></textarea>
                                                        </div> 	
                                                    </div> 	
                                                    <div id="two_column_content_section">
                                                        ...
                                                        <div class="form-group">
                                                        <textarea name="two_column_content" class="tinymce"><?php echo set_value('two_column_content');?></textarea>
                                                        </div> 	
                                                    </div>
                                                    <div id="three_column_content_section">
                                                        ...
                                                        <div class="form-group">
                                                        <textarea name="three_column_content" class="tinymce"><?php echo set_value('three_column_content');?></textarea>
                                                        </div> 	
                                                    </div>
                                                    <div id="four_column_content_section">
                                                        ...
                                                        <div class="form-group">
                                                        <textarea name="four_column_content" class="tinymce"><?php echo set_value('four_column_content');?></textarea>
                                                        </div> 	
                                                    </div>
                                                </div>
												<br />
												<div class="form-group"> 
													...
													if(set_value('disable_in_mobile') == 0) {
