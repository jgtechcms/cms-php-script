...
$(document).ready(function(){
	...
	*/ ?>
	$('.insert_status').click( function() {
		...
		window.location = '<?php echo site_url($customer_admin['dashboard_url'].'/'.$site_models['extension'].'/category/insert/');?>'+menu_id+'/'+status;
	});
							...
							<div class="form-group" style="text-align:center; padding:20px 0;">															
								<div class="form-group table-responsive" style="padding:20px 0;">	
									<table class="table">
										...
										<?php 
										foreach($category_extension_data as $category_data):
											$id = $category_data->menu_id;
