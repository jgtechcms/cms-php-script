...
if($asset_path)
{
	...
	{
		$explode = explode('|', $asset_path);
		if(count($explode) == 2) {
			$asset_path = $explode[0];
			$sub_folder = $explode[1].'/';
...
$config = array(
	...
	*/
	...
	'edit_text_files'                         => false,//true, // eg.: txt, log etc.
	'create_text_files'                       => false,//true, // only create files with exts. defined in $editable_text_file_exts
	...
	'ext_file'                                => array(),//array( 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai' ), //Files
